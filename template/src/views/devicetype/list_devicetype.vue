...
<template>
    lấy api get all device type rồi ném vào list này
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <h5>DataView</h5>
                    ...
                    <template #list="slotProps">
                        <div class="col-12">
                            <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                                <img  src="./../../../public/demo/images/product/bamboo-watch.jpg" :alt="slotProps.data.name" class="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-5" />
                        ...
                        <div class="col-12 md:col-4">
                            <div class="card m-3 border-1 surface-border">
                                ...
                                <div class="text-center">
                                    <img src="./../../../public/demo/images/product/bamboo-watch.jpg" :alt="slotProps.data.name" class="w-9 shadow-2 my-3 mx-0" />
